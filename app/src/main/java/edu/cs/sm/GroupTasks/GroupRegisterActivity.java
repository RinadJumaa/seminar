...
public class GroupRegisterActivity extends AppCompatActivity {
    ...
    private String register_url = "http://192.168.0.101/groupLoginandRegistration/register.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(edu.cs.sm.GroupTasks.GroupRegisterActivity.this, edu.cs.sm.GroupTasks.GroupLoginActivity.class);
                startActivity(i);
                finish();
            }
        });
    ...
    private void displayLoader() {
        pDialog = new ProgressDialog(edu.cs.sm.GroupTasks.GroupRegisterActivity.this);
    ...
    private void registerUser() {
        ...
        edu.cs.sm.GroupTasks.GroupMySingleton.getInstance(this).addToRequestQueue(jsArrayRequest);
    }
